...
class Compute:
    ...
    def _send_otp_via_sms(self, phone_number, otp):
        ...
        query_params["msg"] = f"Dear user, use {otp} as One Time Password generated by Three Dots & Dash to log in to your Sukoon.Love account.",
    ...
    def _generate_and_send_otp(self):
        ...
        status_code, message = self._send_otp_via_sms(
