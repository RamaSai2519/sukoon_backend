from shared.models.interfaces import CalculateWinnerInput as Input, Output
...
class Compute:
    ...
    def compute(self):
        ...
        saarthi_score = self._calculate_final__game_score(
            self.input.saarthi_id)

        return Output(
            output_details={"user_score": user_score,
                            "saarthi_score": saarthi_score},
