...
from models.create_club_interest.compute import Compute
from models.create_club_interest.validate import Validator
from shared.models.interfaces import CreateClubInterestInput as Input, Output


class CreateClubInterest:
