...
from models.get_ad_clicks.compute import Compute
from models.get_ad_clicks.validate import Validator
from shared.models.interfaces import GetAdClicksInput as Input, Output
