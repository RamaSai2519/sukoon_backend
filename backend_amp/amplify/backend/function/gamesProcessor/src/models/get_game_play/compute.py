from shared.models.interfaces import GetGamePlayInput as Input, Output
...
class Compute:
    ...
    def _get_game_play(self) -> dict:
        ...
        user_game_plays = list(user_game_play_collection.find(
            {"userId": self.input.user_id}, {"_id": 0}))
