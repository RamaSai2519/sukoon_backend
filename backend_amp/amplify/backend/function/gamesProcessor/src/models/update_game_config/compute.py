...
from shared.models.interfaces import UpdateGameConfigInput as Input, Output
from shared.models.constants import OutputStatus
from shared.db.games import get_games_config_collection
...
class Compute:
    ...
    def _update_game_config(self) -> None:
        ...
        game_config_db = games_config_collection.find_one(
            {"gameType": self.input.game_type, "level": level})
