...
from models.create_non_registered_user.compute import Compute
from models.create_non_registered_user.validate import Validator


class CreateNonRegisteredUser:
