...
from shared.models.interfaces import GetGameConfigInput as Input, Output
...
class Compute:
    ...
    def _get_game_config(self) -> dict:
        ...
        game_config = list(games_config_collection.find(
            {"gameType": self.input.game_type}, {"_id": 0}))
        return game_config
